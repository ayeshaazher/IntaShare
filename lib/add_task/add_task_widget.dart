            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(28.0, 12.0, 0.0, 0.0),
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'ad7rpgad' /* Due date */,
                      ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      _model.time = _model.datePicked2;
                      safeSetState(() {});
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      ...
                      action: () async {
                        ...
                        await TaskRecord.collection
                            ...
                            .set(createTaskRecordData(
                              taskDetails: _model.textController.text,
                              taskDate: _model.datePicked1,
                              taskTime: _model.datePicked2,
                              userId: currentUserUid,
                              status: false,
                              taskId: _model.id?.toString(),
                            ));
                        _model.date = null;
                        _model.time = null;
                        safeSetState(() {});
                        ...
                        FFAppState().clearTaskCache();
                        FFAppState().clearFullTaskCache();
