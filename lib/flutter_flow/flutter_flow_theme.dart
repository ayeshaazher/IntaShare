...
class ThemeTypography extends Typography {
  ...
  String get titleLargeFamily => 'Heebo';
  bool get titleLargeIsCustom => false;
  TextStyle get titleLarge => GoogleFonts.heebo(
        color: theme.primaryText,
        fontWeight: FontWeight.w500,
        fontSize: 22.0,
      );
  String get titleMediumFamily => 'Heebo';
  bool get titleMediumIsCustom => false;
  TextStyle get titleMedium => GoogleFonts.heebo(
        color: theme.info,
        fontWeight: FontWeight.w500,
        fontSize: 18.0,
      );
  String get titleSmallFamily => 'Heebo';
  bool get titleSmallIsCustom => false;
  TextStyle get titleSmall => GoogleFonts.heebo(
        color: theme.info,
        fontWeight: FontWeight.w500,
        fontSize: 16.0,
      );
  String get labelLargeFamily => 'Heebo';
  bool get labelLargeIsCustom => false;
  TextStyle get labelLarge => GoogleFonts.heebo(
        color: theme.secondaryText,
        fontWeight: FontWeight.w500,
        fontSize: 14.0,
      );
  String get labelMediumFamily => 'Heebo';
  bool get labelMediumIsCustom => false;
  TextStyle get labelMedium => GoogleFonts.heebo(
        color: theme.secondaryText,
        fontWeight: FontWeight.w500,
        fontSize: 12.0,
      );
  String get labelSmallFamily => 'Heebo';
  bool get labelSmallIsCustom => false;
  TextStyle get labelSmall => GoogleFonts.heebo(
        color: theme.secondaryText,
        fontWeight: FontWeight.w500,
        fontSize: 11.0,
      );
  String get bodyLargeFamily => 'Heebo';
  bool get bodyLargeIsCustom => false;
  TextStyle get bodyLarge => GoogleFonts.heebo(
        color: theme.primaryText,
        fontSize: 16.0,
      );
  String get bodyMediumFamily => 'Heebo';
  bool get bodyMediumIsCustom => false;
  TextStyle get bodyMedium => GoogleFonts.heebo(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 14.0,
      );
  String get bodySmallFamily => 'Heebo';
  bool get bodySmallIsCustom => false;
  TextStyle get bodySmall => GoogleFonts.heebo(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 12.0,
      );
