...
class BusinessProjectsRecord extends FirestoreRecord {
  BusinessProjectsRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('businessProjects')
          : FirebaseFirestore.instance.collectionGroup('businessProjects');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('businessProjects').doc(id);

  static Stream<BusinessProjectsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => BusinessProjectsRecord.fromSnapshot(s));

  static Future<BusinessProjectsRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => BusinessProjectsRecord.fromSnapshot(s));

  static BusinessProjectsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      BusinessProjectsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static BusinessProjectsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      BusinessProjectsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'BusinessProjectsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is BusinessProjectsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createBusinessProjectsRecordData({
  String? jobtittle,
...
class BusinessProjectsRecordDocumentEquality
    implements Equality<BusinessProjectsRecord> {
  const BusinessProjectsRecordDocumentEquality();

  @override
  bool equals(BusinessProjectsRecord? e1, BusinessProjectsRecord? e2) {
  ...
  @override
  int hash(BusinessProjectsRecord? e) => const ListEquality().hash([
        e?.jobtittle,
  ...
  @override
  bool isValidKey(Object? o) => o is BusinessProjectsRecord;
}
