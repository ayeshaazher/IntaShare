                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (widget.chatMessagesRef?.meetRef !=
                                          null)
                                        wrapWithModel(
                                          model: _model.adminMessageModel1,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: AdminMessageWidget(
                                            meetRef: widget
                                                .chatMessagesRef!.meetRef!,
                                          ),
                                        ),
                                    ],
                                  ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.chatMessagesRef?.meetRef != null)
                              wrapWithModel(
                                model: _model.adminMessageModel2,
                                updateCallback: () => safeSetState(() {}),
                                child: AdminMessageWidget(
                                  meetRef: widget.chatMessagesRef!.meetRef!,
                                ),
                              ),
                          ],
                        ),
