...
class TaskManagementWidget extends StatefulWidget {
  ...
  static String routeName = 'taskManagement';
  static String routePath = '/taskManagement';
                          ...
                          stream: FFAppState().fullTask(
                            requestFn: () => queryTaskRecord(
                              queryBuilder: (taskRecord) => taskRecord
                                  ...
                                  .orderBy('taskTime', descending: true),
                              limit: 2,
                            ),
                          ),
                                ...
                                child: Container(
                                  ...
                                  child: EmptyStateSimpleWidget(
                                    ...
                                    title: FFLocalizations.of(context).getText(
                                      'x4lz9vrb' /* Task Record */,
                                    ),
                                    body: FFLocalizations.of(context).getText(
                                      'k16218jm' /* No task added yet */,
                                    ),
                                  ),
                                ),
                              );
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                listViewTaskRecord.taskDetails,
