...
import 'contack_details_model.dart';
export 'contack_details_model.dart';

class ContackDetailsWidget extends StatefulWidget {
  const ContackDetailsWidget({
    super.key,
    required this.page,
  });
  ...
  static String routeName = 'contackDetails';
  static String routePath = '/contactDetails';

  @override
  State<ContackDetailsWidget> createState() => _ContackDetailsWidgetState();
}

class _ContackDetailsWidgetState extends State<ContackDetailsWidget> {
  late ContackDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContackDetailsModel());
    ...
    _model.homeadressTextController ??= TextEditingController();
    _model.homeadressFocusNode ??= FocusNode();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 29.0, 24.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      child: TextFormField(
                        controller: _model.homeadressTextController,
                        focusNode: _model.homeadressFocusNode,
                        autofocus: false,
                        obscureText: false,
                        decoration: InputDecoration(
                          isDense: true,
                        ...
                        cursorColor: Colors.black,
                        validator: _model.homeadressTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: Colors.black,
                        validator: _model.linkedinTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                      ...
                      child: ButtonWidget(
                        ...
                        action: () async {
                          ...
                          if (widget.page == 'business') {
                            await BusinessContactDetailsRecord.createDoc(
                                    currentUserReference!)
                                .set(createBusinessContactDetailsRecordData(
                              phoneNum:
                                  int.tryParse(_model.phoneTextController.text),
                              emailAdress: _model.emailTextController.text,
                              homeAdress: _model.homeadressTextController.text,
                              whatsapLink: _model.whatsappTextController.text,
                              linkedinLink: _model.linkedinTextController.text,
                              instagramLink:
                                  _model.instagramTextController.text,
                              facebookLink: _model.facebookTextController.text,
                            ));
                          } else {
                            await ContactDetailsRecord.createDoc(
                                    currentUserReference!)
                                .set(createContactDetailsRecordData(
                              phoneNum:
                                  int.tryParse(_model.phoneTextController.text),
                              emailAdress: _model.emailTextController.text,
                              homeAdress: _model.homeadressTextController.text,
                          ...
                          safeSetState(() {
                            ...
                            _model.homeadressTextController?.clear();
                            _model.whatsappTextController?.clear();
